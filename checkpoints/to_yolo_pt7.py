...
memory_encoder = MemoryEncoder(out_dim= 512, position_encoding=position_encoding, mask_downsampler=mask_downsampler, fuser=fuser, in_dim=512, no_mask_downsampler=True)#no_mask_downsampler= True)#, only_pos=True)
