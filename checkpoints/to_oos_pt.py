...
ckpt_path = "/home/user/sdragon/sam2/checkpoints/OO_v11s_SAVPE_SigLIP2_FT_multi_layer_135.pt"
with g_pathmgr.open(ckpt_path, "rb") as f:
...
mask_downsampler = MaskDownSampler(embed_dim=256, in_chans= 74, has_mask_down=False)
...
memory_encoder = MemoryEncoder(out_dim= 256, position_encoding=position_encoding, mask_downsampler=mask_downsampler, fuser=fuser, in_dim=256, no_mask_downsampler= True)#, only_pos=True)
...
output_path = "oom11_s_num_maskmem_1_memory_position_0_no_mask_downsampler_downsampler_attentionlayer_1.pt"
# 儲存新的模型權重
