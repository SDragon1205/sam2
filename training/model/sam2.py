...
class SAM2Train(SAM2Base):
    ...
    def forward_tracking(
        ...
        def get_list_shape(lst):
            ...
            if isinstance(lst, list):
                if not lst:  # 空列表情況
                    return (0,)
                return f"{len(lst)}, {lst[0].shape}, {lst[1].shape}, {lst[2].shape}"
            return ()  # 非列表結束遞迴
        
        # flatten NxCxHxW to HWxNxC, N is batch * frame
        # print("vision_feats", get_list_shape(vision_feats))
        # print("vision_pos_embeds", get_list_shape(vision_pos_embeds))
    ...
    def _iter_correct_pt_sampling(
        ...
        for _ in range(self.num_correction_pt_per_frame):
            ...
            # print("============================================================================")
            # print("_iter_correct_pt_sampling")
