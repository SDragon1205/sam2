...
class v2vdet_class():
    def __init__(self):
        ...
        self.model = v2vYOLOWorld("v2vdet_ultralytics/cfg/models/v8/yolov8s-world.yaml")
        self.ckpt_path = "training_result/v2vdet/lvis_v2vdet_world_train_project_original_100_epochs_20250128_2336/weights/best.pt"
