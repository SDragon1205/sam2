...
CKPT_NAME = 'v2v_training_result/from_H100/SigLIP2_series/OO_v11s_SAVPE_SigLIP2_FT_multi_layer_135/weights/best.pt'
...
class v2vdet_class():
    def __init__(self):
        ...
        # Initialize model
        self.model = V2V_With_MultiScale_SAVPE_ObjectOriented(MODEL_YAML)
        self.model.info()
