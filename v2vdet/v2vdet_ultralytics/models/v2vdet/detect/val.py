...
from v2vdet.v2vdet_ultralytics.engine.validator import BaseValidator
...
class DetectionValidator(BaseValidator):
    ...
    def build_dataset(self, img_path, mode="val", batch=None):
        ...
        """
        dataset = build_yolo_dataset(self.args, img_path, batch, self.data, mode=mode, stride=self.stride)
