...
def main():
  data = dict(
    train=dict(
        yolo_data=["v2vdet_ultralytics/cfg/datasets/Objects365_t8k_v1024.yaml"],
    ...
    val=dict(yolo_data=["v2vdet_ultralytics/cfg/datasets/Objects365_t8k_v1024.yaml"]),
  )
  wandb_enable = True
  ...
  project_name = 'v2vdet'
  ckpt_name = 'ckpt/yolov8s-worldv2.pt'
  name = f"SA_V_train8k_Template_YOLO_Backbone_Share_Param_yoloworldv2"
  ...
  model = V2V_Template_YOLO_Backbone_Share_Param("ultralytics/cfg/models/v8/yolov8s-worldv2.yaml")
