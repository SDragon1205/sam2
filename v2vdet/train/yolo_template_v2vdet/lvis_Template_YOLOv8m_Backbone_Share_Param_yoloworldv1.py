...
def main():
  ...
  name = f"lvis_Template_YOLOv8m_Backbone_Share_Param_new_teamplate_args_method"
  ...
  model = V2V_Template_YOLO_Backbone_Share_Param("ultralytics/cfg/models/v8/yolov8m-world.yaml")
