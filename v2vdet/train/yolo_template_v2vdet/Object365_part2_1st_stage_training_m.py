...
def main():
  ...
  project_name = 'v2vdet'
  ckpt_name = 'training_result/v2vdet/bb_share_yolov8m_param_Object365_part1_1st_stage_training/weights/best.pt'
  name = f"bb_share_yolov8m_param_Object365_part2_1st_stage_training"
