...
def main():
  ...
  project_name = 'v2vdet'
  ckpt_name = 'training_result/v2vdet/bb_share_yolov8l_param_LVIS_1st_stage_training/weights/last.pt'
  name = f"bb_share_yolov8l_param_LVIS_1st_stage_training_from_previous_exp"
