...
def main():
  data = dict(
    train=dict(
        yolo_data=["v2vdet_ultralytics/cfg/datasets/Objects365_1.yaml"],
    ...
    val=dict(yolo_data=["v2vdet_ultralytics/cfg/datasets/Objects365_1.yaml"]),
  )

  project_name = 'v2vdet'
  ckpt_name = 'training_result/v2vdet/lvis_Template_YOLO_s_Backbone_Share_Param_75_percent_nonblack_background/weights/best.pt'
  #training_result/v2vdet/Object365_part1_1st_stage_training_s_75_percent_nonblack_background/weights/best.pt
  name = f"Object365_part1_1st_stage_training_s_75_percent_nonblack_background"
