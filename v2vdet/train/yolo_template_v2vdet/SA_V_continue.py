...
def main():
  data = dict(
    train=dict(
        yolo_data=["v2vdet_ultralytics/cfg/datasets/SA_V.yaml"],
    ...
    val=dict(yolo_data=["v2vdet_ultralytics/cfg/datasets/SA_V.yaml"]),
  )
  wandb_enable = True
  ...
  name = f"SA_V_Template_YOLO_Backbone_Share_Param_Cont"
