...
def main():
  ...
  project_name = 'v2vdet_A100'
  ckpt_name = 'ckpt/yolov8l-world.pt'
  name = f"LVIS_Template_YOLO_L_Backbone_Share_Param_from_scratch"

  model = V2V_Template_YOLO_Backbone_Share_Param("ultralytics/cfg/models/v8/yolov8l-world.yaml")
