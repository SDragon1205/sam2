...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_Template_YOLO_Backbone_Share_Param_Segm_Dataset
...
DATA_PATH = f"v2vdet_ultralytics/cfg/datasets/lvis.yaml"
...
def main():
  ...
  project_name = 'v2vdet_share_parameter_v8s_lvis_with_segm_cropping'
  ckpt_name = 'ckpt/yolov8s-world.pt'
  name = f"{project_name}/share_parameter_v8s_lvis_backgroundprob75"

  model = V2V_Template_YOLO_Backbone_Share_Param_Segm_Dataset("v2vdet_ultralytics/cfg/models/v8/yolov8s-world.yaml")
