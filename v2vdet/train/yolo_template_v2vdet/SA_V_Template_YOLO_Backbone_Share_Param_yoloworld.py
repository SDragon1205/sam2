...
def main():
  ...
  name = f"SA_V_train8k_Template_YOLO_Backbone_Share_Param_yoloworld"
  ...
  model = V2V_Template_YOLO_Backbone_Share_Param("ultralytics/cfg/models/v8/yolov8s-world.yaml")
