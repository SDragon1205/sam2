...
def main():
  ...
  project_name = 'v2vdet'
  ckpt_name = 'training_result/v2vdet/bb_share_yolov8l_param_LVIS_1st_stage_training/weights/best.pt'
  name = f"bb_share_yolov8l_param_Object365_part1_1st_stage_training"
  ...
  model = V2V_Template_YOLO_Backbone_Share_Param("v2vdet_ultralytics/cfg/models/v8/yolov8l-world.yaml")
