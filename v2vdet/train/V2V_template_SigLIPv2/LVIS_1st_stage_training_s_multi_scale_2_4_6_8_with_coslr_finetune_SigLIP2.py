...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_template_SigLIPv2_multi_scale
...
DATASET_YAML = "v2vdet_ultralytics/cfg/datasets/lvis_min_val.yaml"
BATCH_SIZE = 8
EPOCHS = 10
...
NAME = f"LVIS_SigLIP2_multi_scale_2_4_6_8_with_coslr_FT"
...
def main():
  ...
  model = V2V_template_SigLIPv2_multi_scale("./v2vdet_ultralytics/cfg/models/v2v/yolov8s-world_multiscale_2_4_6_8.yaml")
