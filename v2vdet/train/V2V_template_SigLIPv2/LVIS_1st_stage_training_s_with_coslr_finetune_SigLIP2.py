...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_template_SigLIPv2
import torch
...
NAME = f"LVIS_SigLIP2_with_cos_lr_FT"
...
def main():
  ...
  model = V2V_template_SigLIPv2("ultralytics/cfg/models/v8/yolov8s-world.yaml")
