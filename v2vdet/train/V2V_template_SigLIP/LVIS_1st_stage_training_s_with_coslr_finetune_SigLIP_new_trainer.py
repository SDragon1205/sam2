...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_template_SigLIP_with_new_dataset
import torch
...
def main():
  ...
  name = f"V2V_template_yolos_SigLIP_with_cos_lr_finetune_SigLIP_segm_dataset_prob25"

  model = V2V_template_SigLIP_with_new_dataset("ultralytics/cfg/models/v8/yolov8s-world.yaml")
  ...
  result = model.train(
    ...
    template_background_ratio = 0.25
    )
