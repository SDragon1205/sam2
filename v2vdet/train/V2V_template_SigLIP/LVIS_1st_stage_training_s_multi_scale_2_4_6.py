...
def main():
  ...
  name = f"V2V_template_yolos_SigLIP_multi_scale_2_4_6"

  model = V2V_template_SigLIP_multi_scale("v2vdet_ultralytics/cfg/models/v2v/yolov8s-world_multiscale_2_4_6.yaml")
