...
DATA_PATH = f"v2vdet_ultralytics/cfg/datasets/Objects365_t8k_v1024.yaml"
...
def main():
  ...
  project_name = 'v2vdet_SigLIP_Object365'
  ckpt_name = 'ckpt/yolov8s-world.pt'
  name = f"V2V_template_yolos_SigLIP_multi_scale_2_4_6_8_with_coslr_finetune_SigLIP_worldv2_backgroundprob75"

  model = V2V_template_SigLIP_multi_scale("v2vdet_ultralytics/cfg/models/v2v/yolov8s-worldv2_multiscale_2_4_6_8.yaml")
