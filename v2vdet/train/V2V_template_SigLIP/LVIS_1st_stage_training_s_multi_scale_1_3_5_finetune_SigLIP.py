...
def main():
  ...
  name = f"V2V_template_yolos_SigLIP_multi_scale_1_3_5_finetune_SigLIP"

  model = V2V_template_SigLIP_multi_scale("v2vdet_ultralytics/cfg/models/v2v/yolov8s-world_multiscale_1_3_5.yaml")
