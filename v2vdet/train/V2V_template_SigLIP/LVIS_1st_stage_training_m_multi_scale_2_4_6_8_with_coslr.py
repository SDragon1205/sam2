...
def main():
  ...
  name = f"V2V_template_yolom_SigLIP_multi_scale_2_4_6_8_with_coslr"

  model = V2V_template_SigLIP_multi_scale("v2vdet_ultralytics/cfg/models/v2v/yolov8m-world_multiscale_2_4_6_8.yaml")
