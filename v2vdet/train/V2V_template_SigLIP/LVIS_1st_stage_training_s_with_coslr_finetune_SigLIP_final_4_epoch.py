...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_template_SigLIP
import torch
...
def main():
  ...
  ckpt_name = 'training_result/v2vdet_SigLIP/V2V_template_yolos_SigLIP_with_cos_lr_finetune_SigLIP/weights/best.pt'
  name = f"V2V_template_yolos_SigLIP_with_cos_lr_finetune_SigLIP_final_4_epoch"

  model = V2V_template_SigLIP("ultralytics/cfg/models/v8/yolov8s-world.yaml")
