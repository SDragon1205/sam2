...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_template_SigLIP_multi_scale_multi_head
...
def main():
  ...
  name = f"V2V_template_yolos_SigLIP_multi_scale_2_4_6_8_with_coslr_finetune_SigLIP_with_multihead_attn_pooling_prob25"

  model = V2V_template_SigLIP_multi_scale_multi_head("./v2vdet_ultralytics/cfg/models/v2v/yolov8s-world_multiscale_2_4_6_8.yaml")
  
  model._load(ckpt_name, task='task')
  if wandb_enable & RANK in {-1, 0}:
