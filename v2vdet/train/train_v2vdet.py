...
if __name__ == "__main__":
  ...
  if (wandb_enable):
    ...
    wandb.init(project='v2vdet_train_project', name=ckpt_name)
    add_wandb_callback(model, enable_model_checkpointing=True)
  result = model.train(data=data, batch=4, epochs=20, trainer=v2vTrainerFromScratch, project='v2vdet_train_project', name=ckpt_name, save_period=1, cache=True, exist_ok=True, plots=True)
