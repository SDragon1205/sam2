...
MODEL_YAML = "v2vdet_ultralytics/cfg/models/v2v/v9/yolov9m-v2v-multiscale_135.yaml"
BATCH_SIZE = 64
EPOCHS = 10
NUM_WORKERS = 12
EVAL_BATCH_SIZE = 4
...
CKPT_NAME = 'ckpt/yolov9m.pt'
NAME = f"v9m_SAVPE_SigLIP2_FT_multi_layer_135_LVIS"
