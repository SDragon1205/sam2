...
MODEL_YAML = "v2vdet_ultralytics/cfg/models/v2v/v8/yolov8-v2v-multiscale_135.yaml"
BATCH_SIZE = 32
EPOCHS = 10
NUM_WORKERS = 16
EVAL_BATCH_SIZE = 4
...
CKPT_NAME = 'ckpt/yolo8s.pt'
NAME = f"v8s_SAVPE_SigLIP2_FT_multi_layer_123_Object365_80k"
