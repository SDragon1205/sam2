...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_With_MultiScale_SAVPE_SigLIP2_L
import torch
...
CKPT_NAME = f'ckpt/v11m_SAVPE_SigLIP2_L_FT_multi_layer_135_Object365.pt'
NAME = f"v11{scale}_SAVPE_SigLIP2_L_FT_multi_layer_135_Object365_conti"
FROZEN_VISION_ENCODER = False

def main():
  
  model = V2V_With_MultiScale_SAVPE_SigLIP2_L(MODEL_YAML)
  ...
  # eval_function(MODEL=V2V_With_MultiScale_SAVPE_SigLIP2_L,
