...
MODEL_YAML = f"v2vdet_ultralytics/cfg/models/v2v/v8/yolov8{scale}-v2v-multiscale_135.yaml"
BATCH_SIZE = 64
EPOCHS = 10
NUM_WORKERS = 16
EVAL_BATCH_SIZE = 2
...
CKPT_NAME = f'ckpt/yolov8{scale}.pt'
NAME = f"v8{scale}_SAVPE_SigLIP2_L_FT_multi_layer_135_Object365_80k"
