...
DATASET_YAML = "v2vdet_ultralytics/cfg/datasets/lvis.yaml"
MODEL_YAML = "v2vdet_ultralytics/cfg/models/v2v/11/yolo11m-v2v-multiscale_1_3_5.yaml"
BATCH_SIZE = 64
EPOCHS = 10
NUM_WORKERS = 24
EVAL_BATCH_SIZE = 4
...
CKPT_NAME = 'ckpt/yolo11m.pt'
NAME = f"v11m_SAVPE_SigLIP2_FT_multi_layer_135_LVIS"
FROZEN_VISION_ENCODER = False

def main():
  
  model = V2V_With_MultiScale_SAVPE(MODEL_YAML)
