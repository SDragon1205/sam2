...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_With_MultiScale_SAVPE_PE_B16_ObjectOriented
import torch
...
CKPT_NAME = f'ckpt/v11m_SAVPE_PE_B16_FT_multi_layer_135_Object365.pt'
NAME = f"OO_v11{scale}_SAVPE_PE_B16_FT_multi_layer_135_Object365_conti"
FROZEN_VISION_ENCODER = False

def main():
  
  model = V2V_With_MultiScale_SAVPE_PE_B16_ObjectOriented(MODEL_YAML)
