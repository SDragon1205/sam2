...
TRAIN_DATASET_YAML = "v2vdet_ultralytics/cfg/datasets/ABO_train.yaml"
VAL_DATASET_YAML = "v2vdet_ultralytics/cfg/datasets/ABO_unseen_val.yaml"
...
NAME = f"OO_v11{scale}_SAVPE_PE_L14_multi_layer_678_eval_unseen"
...
def main():
  ...
  data = dict(
    train=dict(
        yolo_data=[TRAIN_DATASET_YAML],
    ),
    val=dict(yolo_data=[TRAIN_DATASET_YAML]),
  )
  wandb_enable = True
