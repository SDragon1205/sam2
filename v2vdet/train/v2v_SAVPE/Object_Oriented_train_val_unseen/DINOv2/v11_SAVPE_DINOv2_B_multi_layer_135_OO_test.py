...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_With_MultiScale_SAVPE_DINOv2_B_ObjectOriented as MODEL
import torch
from ultralytics import YOLO

device = os.environ.get('CUDA_VISIBLE_DEVICES', 0)
scale = os.environ.get('SCALE', 's')
DATASET_YAML = "v2vdet_ultralytics/cfg/datasets/ABO_100_testing_64.yaml"
MODEL_YAML = f"v2vdet_ultralytics/cfg/models/v2v/11/yolo11{scale}-v2v-multiscale_1_3_5.yaml"
BATCH_SIZE = int(os.environ.get('BATCH_SIZE', default=4))
EPOCHS = 5
NUM_WORKERS = 0
EVAL_BATCH_SIZE = 2
...
NAME = f"OO_v11{scale}_SAVPE_DINOv2_B_multi_layer_135"
