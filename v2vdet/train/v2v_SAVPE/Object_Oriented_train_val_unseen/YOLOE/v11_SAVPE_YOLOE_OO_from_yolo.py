...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_With_MultiScale_SAVPE_YOLOE_ObjectOriented 
import torch
from ultralytics import YOLO

device = os.environ.get('CUDA_VISIBLE_DEVICES', 0)
scale = os.environ.get('SCALE', 's')
DATASET_YAML = "v2vdet_ultralytics/cfg/datasets/ABO_256.yaml"
MODEL_YAML = f"v2vdet_ultralytics/cfg/models/11/yoloe-11{scale}.yaml"
...
NAME = f"OO_v11{scale}_SAVPE_YOLOE_from_yolo"
FROZEN_VISION_ENCODER = False

def main():
  
  model = V2V_With_MultiScale_SAVPE_YOLOE_ObjectOriented(MODEL_YAML, task='detect')
