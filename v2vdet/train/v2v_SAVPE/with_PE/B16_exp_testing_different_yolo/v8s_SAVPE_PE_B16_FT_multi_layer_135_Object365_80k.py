...
MODEL_YAML = "v2vdet_ultralytics/cfg/models/v2v/v8/yolov8s-v2v-multiscale_135.yaml"
BATCH_SIZE = 32
EPOCHS = 10
NUM_WORKERS = 16
EVAL_BATCH_SIZE = 4
...
CKPT_NAME = 'ckpt/yolov8s.pt'
NAME = f"v8s_SAVPE_PE_B16_FT_multi_layer_135_Object365_80k"
