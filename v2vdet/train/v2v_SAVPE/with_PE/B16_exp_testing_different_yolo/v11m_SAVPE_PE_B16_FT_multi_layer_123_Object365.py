...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_With_MultiScale_SAVPE_PE_B16
import torch
...
scale='m'
DATASET_YAML = "v2vdet_ultralytics/cfg/datasets/Objects365_alltrain_min_val.yaml"
MODEL_YAML = f"v2vdet_ultralytics/cfg/models/v2v/11/yolo11{scale}-v2v-multiscale_1_2_3.yaml"
BATCH_SIZE = 128
EPOCHS = 5
NUM_WORKERS = 16
EVAL_BATCH_SIZE = 8
...
NAME = f"v11{scale}_SAVPE_PE_B16_FT_multi_layer_123_Object365"
FROZEN_VISION_ENCODER = False

def main():
  
  model = V2V_With_MultiScale_SAVPE_PE_B16(MODEL_YAML)
  ...
  # PROJECT_NAME='V2V_With_MultiScale_SAVPE_PE_B16'

  # ckpt_name = f'v2v_training_result/{NAME}/weights/best.pt'
  
  # eval_function(MODEL=V2V_With_MultiScale_SAVPE_PE_B16,
