...
MODEL_YAML = "v2vdet_ultralytics/cfg/models/v2v/11/yolo11s-v2v-multiscale_1_3_5.yaml"
BATCH_SIZE = 32
EPOCHS = 10
NUM_WORKERS = 16
EVAL_BATCH_SIZE = 4
...
CKPT_NAME = 'ckpt/yolo11s.pt'
NAME = f"v11s_SAVPE_PE_B16_FT_multi_layer_135_Object365_80k"
