...
MODEL_YAML = f"v2vdet_ultralytics/cfg/models/v2v/12/yolo12{scale}-v2v-multiscale_135.yaml"
BATCH_SIZE = 32
EPOCHS = 10
NUM_WORKERS = 16
EVAL_BATCH_SIZE = 4
...
CKPT_NAME = f'ckpt/yolo12{scale}.pt'
NAME = f"v12{scale}_SAVPE_PE_B16_FT_multi_layer_135_Object365_80k"
