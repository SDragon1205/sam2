...
MODEL_YAML = "v2vdet_ultralytics/cfg/models/v2v/12/yolo12s-v2v-multiscale_135.yaml"
BATCH_SIZE = 32
EPOCHS = 10
NUM_WORKERS = 16
EVAL_BATCH_SIZE = 4
...
CKPT_NAME = f'ckpt/yolo12s.pt'
NAME = f"v12s_SAVPE_PE_B16_FT_multi_layer_135_Object365_80k"
...
def main():
  ...
  PROJECT_NAME='SAVSAVPE_PE_v2vPE_v2v'

  ckpt_name = f'v2v_training_result/{NAME}/weights/best.pt'
  
  eval_function(MODEL=V2V_With_MultiScale_SAVPE_PE,
