...
CKPT_NAME = f'ckpt/v11m_SAVPE_PE_L14_FT_multi_layer_678_Object365.pt'
NAME = f"v11{scale}_SAVPE_PE_L14_FT_multi_layer_678_Object365_conti"
FROZEN_VISION_ENCODER = False

def main():
  
  model = V2V_With_MultiScale_SAVPE_PE_L14(MODEL_YAML)
  ...
  eval_function(MODEL=V2V_With_MultiScale_SAVPE_PE_L14,
