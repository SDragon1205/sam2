...
MODEL_YAML = "v2vdet_ultralytics/cfg/models/v2v/yolov8s-world_multiscale_2_4_6_8.yaml"
BATCH_SIZE = 8
EPOCHS = 5
...
NAME = f"SigLIP2_FT_multi_layer_2468"
FROZEN_VISION_ENCODER = False

def main():
  
  model = V2V_template_SigLIPv2_multi_scale(MODEL_YAML)
