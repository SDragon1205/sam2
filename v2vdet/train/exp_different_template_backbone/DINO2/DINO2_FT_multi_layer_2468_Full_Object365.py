...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_DINO_multi_scale
import torch
...
NAME = f"DINO2_FT_multi_layer_2468_Full_Object365"
FROZEN_VISION_ENCODER = False

def main():
  
  model = V2V_DINO_multi_scale(MODEL_YAML)
