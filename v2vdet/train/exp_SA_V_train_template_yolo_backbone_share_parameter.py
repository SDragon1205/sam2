...
def main():
  # data = dict(
  #   train=dict(
  #       yolo_data=["v2vdet_ultralytics/cfg/datasets/min_SA_V.yaml"],
  ...
  #       # ],
  #   ),
  #   val=dict(yolo_data=["v2vdet_ultralytics/cfg/datasets/min_SA_V.yaml"]),
  # )
  # data = dict(
  #   train=dict(yolo_data=["v2vdet_ultralytics/cfg/datasets/lvis_min.yaml"]),
  #   val=dict(yolo_data=["v2vdet_ultralytics/cfg/datasets/lvis_min.yaml"])
  # )

  data = dict(
    train=dict(yolo_data=["v2vdet_ultralytics/cfg/datasets/min_SA_V.yaml"]),
    val=dict(yolo_data=["v2vdet_ultralytics/cfg/datasets/min_SA_V.yaml"])
  )
  wandb_enable = False
