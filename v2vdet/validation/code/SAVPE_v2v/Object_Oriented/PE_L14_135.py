...
NAME = f"OO_v11{scale}_PE_L14_135"
# CKPT_NAME = f'ckpt/Object_Oriented_CKPT/{NAME}.pt'
# CKPT_NAME = f'ckpt/Object_Oriented_CKPT/{NAME}.pt'
# CKPT_NAME = f'ckpt/offical_yoloe/yoloe-11{scale}-seg.pt'
CKPT_NAME = f"v2v_training_result/from_H100/PE_L14/OO_v11{scale}_SAVPE_PE_L14_FT_multi_layer_135/weights/best.pt"
CKPT_NAME = f"v2v_training_result/from_H100/PE_L14/OO_v11m_SAVPE_PE_L14_FT_multi_layer_135_Object365/weights/best.pt"
