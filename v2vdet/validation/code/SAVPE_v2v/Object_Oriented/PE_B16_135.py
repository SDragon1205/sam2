...
from v2vdet.v2vdet_ultralytics.models.v2vdet.model import V2V_With_MultiScale_SAVPE_PE_B16_ObjectOriented as MODEL
import torch
...
NAME = f"OO_v11{scale}_PE_B16_135"
# CKPT_NAME = f'ckpt/Object_Oriented_CKPT/{NAME}.pt'
# CKPT_NAME = f'ckpt/Object_Oriented_CKPT/{NAME}.pt'
# CKPT_NAME = f'ckpt/offical_yoloe/yoloe-11{scale}-seg.pt'
CKPT_NAME = f"v2v_training_result/from_H100/PE_B16/OO_v11{scale}_SAVPE_PE_B16_FT_multi_layer_135/weights/best.pt"
