...
NAME = f"OO_v11{scale}_SigLIP2_B_135"
# CKPT_NAME = f'ckpt/Object_Oriented_CKPT/{NAME}.pt'
# CKPT_NAME = f'ckpt/Object_Oriented_CKPT/{NAME}.pt'
# CKPT_NAME = f'ckpt/offical_yoloe/yoloe-11{scale}-seg.pt'
CKPT_NAME = f"v2v_training_result/from_H100/SigLIP2_series/OO_v11{scale}_SAVPE_SigLIP2_FT_multi_layer_135/weights/best.pt"
