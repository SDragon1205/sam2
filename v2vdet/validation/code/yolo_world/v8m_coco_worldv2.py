...
def main():
  ...
  name = f"v8{scale}_world_v2"
  
  # ckpt_name = 'ckpt/yolov8s-world.pt'
  
  ckpt_name = f'ckpt/offical_YOLO_World/yolov8{scale}-worldv2.pt'

  model = v2vYOLOWorld(f"v2vdet_ultralytics/cfg/models/v8/yolov8{scale}-worldv2.yaml")
