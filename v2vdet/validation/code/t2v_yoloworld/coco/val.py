...
def main():
  project = "validation/result/t2v_yoloworld/coco"
  name = "yoloworld"
  data_yaml = "v2vdet_ultralytics/cfg/datasets/coco.yaml"
  
  if (os.path.exists(f"{project}/{name}")):
    shutil.rmtree(f"{project}/{name}")
  
  ckpt_name = 'training_result/lvis_yolo_world/20250104_06_29_49/weights/best.pt'
