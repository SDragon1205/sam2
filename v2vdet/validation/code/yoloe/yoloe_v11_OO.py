from v2vdet.v2vdet_ultralytics.models.yolo.model import V2V_With_MultiScale_SAVPE_YOLOE_ObjectOriented as MODEL
import torch
import wandb
import os
import json
...
with torch.inference_mode():
  ...
  NAME = f"YOLOE_11{SCALE}"
  
  for dataset_name in DATASET_LIST:
    print(f"Evaluating on {dataset_name} dataset...")
    model = MODEL(MODEL_YAML, task='detect')
