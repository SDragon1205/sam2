...
from v2vdet.v2vdet_ultralytics.models.v2vdet import V2V_DINO_with_registers
import torch
...
def main():
  ...
  ckpt_name = 'v2v_training_result/DINO2_with_registers_FT_LVIS/weights/best.pt'
  model = V2V_DINO_with_registers("v2vdet_ultralytics/cfg/models/v2v/yolov8s-world.yaml")
