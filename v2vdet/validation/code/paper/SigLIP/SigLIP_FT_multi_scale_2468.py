...
def main():
  ...
  name = "SigLIP_multi_scale_2468_FT_multihead_attn"

  ckpt_name = 'training_result/v2vdet_SigLIP/V2V_template_yolos_SigLIP_multi_scale_2_4_6_8_with_coslr_finetune_SigLIP_with_multihead_attn_pooling_prob25/weights/best.pt'
