...
def main():
  ...
  name = f"train_with_augment_template_{current_time}"
  wandb_name = name
  
  # ckpt_name = 'ckpt/yolov8s-world.pt'
  
  ckpt_name = 'training_result/lvis_v2vdet_world_train_project_original/train_20250110_0125/weights/best.pt'
