...
from v2vdet.v2vdet_ultralytics.models.v2vdet import V2V_template_SigLIP
import torch

def main():

  project = "validation/result"
  name = "LVIS_1st_stage_training_s_with_coslr_finetune_SigLIP_SA_V"

  ckpt_name = 'training_result/v2vdet_SigLIP/V2V_template_yolos_SigLIP_with_cos_lr_finetune_SigLIP_final_4_epoch/weights/best.pt'
  model = V2V_template_SigLIP("v2vdet_ultralytics/cfg/models/v8/yolov8s-world.yaml", task='detect')
