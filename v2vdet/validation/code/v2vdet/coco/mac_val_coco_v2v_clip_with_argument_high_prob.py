...
def main():
  ...
  project = "/Users/user/v2vdet_validation"
  name = "coco_with_high_prob"
  wandb_name = name
  
  # ckpt_name = 'ckpt/yolov8s-world.pt'
  
  ckpt_name = 'training_result/lvis_v2vdet_world_train_project/train_with_augment_template_high_prob/weights/best.pt'
