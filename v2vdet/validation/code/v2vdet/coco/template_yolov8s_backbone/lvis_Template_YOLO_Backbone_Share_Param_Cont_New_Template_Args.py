...
def main():
  ...
  name = "lvis_Template_YOLO_Backbone_Share_Param_yoloworld_new_teamplate_args_method_val"
  ...
  ckpt_name = "ckpt/share_parameter/bb_share_yolov8s_param_Object365_part1_1st_stage_training.pt"
