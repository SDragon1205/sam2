...
def main():
  ...
  name = "lvis_Template_YOLO_Backbone_Share_Param_yoloworld_no_use_class_black"
  
  ckpt_name = 'training_result/v2vdet/lvis_Template_YOLO_Backbone_Share_Param_yoloworld_no_use_class_black/weights/best.pt'
