...
def main():
  ...
  name = "brain_v2vdet_Template_YOLOv8s_Backbone_Share_Param"

  ckpt_name = 'training_result/v2vdet/lvis_Template_YOLO_Backbone_Share_Param_yoloworld_new_teamplate_args_method/weights/best.pt'
  ckpt_name = 'ckpt/lvis_v2vdet_Template_YOLOv8s_Backbone_Share_Param.pt'
  model = V2V_Template_YOLO_Backbone_Share_Param("v2vdet_ultralytics/cfg/models/v8/yolov8s-world.yaml", task='detect')
