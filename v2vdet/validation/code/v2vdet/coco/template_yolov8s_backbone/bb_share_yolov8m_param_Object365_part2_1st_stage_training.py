...
def main():
  ...
  project = "validation/result/bb_share_yolov8m"
  name = "Object365_part2_1st_stage_training_val"
  
  ckpt_name = 'training_result/v2vdet/bb_share_yolov8m_param_Object365_part2_1st_stage_training/weights/best.pt'
