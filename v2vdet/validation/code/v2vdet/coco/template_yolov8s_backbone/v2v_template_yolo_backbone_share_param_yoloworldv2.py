...
def main():
  ...
  name = "lvis_Template_YOLO_Backbone_Share_Param_yoloworldv2"
  
  ckpt_name = 'training_result/v2vdet/lvis_Template_YOLO_Backbone_Share_Param_yoloworldv2/weights/best.pt'
