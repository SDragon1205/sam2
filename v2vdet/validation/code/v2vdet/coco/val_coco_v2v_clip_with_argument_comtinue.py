...
def main():
  ...
  wandb_name = "coco_with_args_continue"
  
  # ckpt_name = 'ckpt/yolov8s-world.pt'
  
  ckpt_name = 'training_result/lvis_v2vdet_world_train_project/continue_train_with_augment_template/weights/best.pt'
  ...
  with open (f"{project}/{wandb_name}/metrics.json", 'w') as f:
