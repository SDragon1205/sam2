...
from v2vdet.v2vdet_ultralytics.models.v2vdet import V2V_multi_scale_clip
import torch

def main():
  
  project = "validation/result/V2V_multi_scale_clip"
  name = "multi_scale_clip_train_all_from_2_4_6_8_attn_lr_1E-2"
  
  ckpt_name = 'training_result/v2vdet/lvis_V2V_multi_scale_clip_train_all_from_2_4_6_8_20250124_0034/weights/best.pt'
  model = V2V_multi_scale_clip(model="v2vdet_ultralytics/cfg/models/v8/yolov8s-world.yaml")
