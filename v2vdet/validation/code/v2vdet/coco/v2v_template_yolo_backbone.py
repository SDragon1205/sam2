...
def main():
  ...
  name = "only_finetune_detection_backbone_lvis_v2vdet_template_yolov8s_backbone_same_yoloworld_ckpt"
  
  ckpt_name = 'training_result/v2vdet/lvis_v2vdet_template_yolov8s_backbone_same_yoloworld_ckpt/weights/best.pt'
