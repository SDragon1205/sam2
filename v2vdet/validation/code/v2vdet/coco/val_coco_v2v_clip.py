...
def main():
  ...
  ckpt_name = 'training_result/v2vdet/lvis_v2vdet_world_train_project_original_100_epochs_20250128_2336/weights/best.pt'
  wandb_name = 'clip_origin_train_100_epochs'
  ...
  wandb.init(project='v2vdet_val', name=wandb_name)
