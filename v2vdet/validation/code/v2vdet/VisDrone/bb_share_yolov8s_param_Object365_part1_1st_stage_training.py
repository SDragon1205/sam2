...
def main():
  ...
  project = "validation/result/v2vdet_template_yolov8s_backbone_VisDrone"
  name = "bb_share_yolov8s_param_Object365_part1_1st_stage_training"
  
  ckpt_name = 'training_result/v2vdet/bb_share_yolov8s_param_Object365_part1_1st_stage_training/weights/best.pt'
