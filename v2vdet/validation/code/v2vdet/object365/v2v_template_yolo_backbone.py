...
def main():
  ...
  name = "val_lvis_only_finetune_detection_backbone"
  
  ckpt_name = 'training_result/v2vdet/lvis_v2vdet_template_yolov8s_backbone_20250204_0028/weights/best.pt'
  ...
  metrics = model.val(data="v2vdet_ultralytics/cfg/datasets/Objects365.yaml",
                    batch=64,
                    save_json=True,
                    half=True,
                    plots = True,
