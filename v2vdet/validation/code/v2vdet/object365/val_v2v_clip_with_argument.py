...
def main():
  ...
  project = "validation/v2vdet/Object365_Result"
  name = "Object365"
  wandb_name = 'Object365'
  
  # ckpt_name = 'ckpt/yolov8s-world.pt'
  
  ckpt_name = 'training_result/lvis_v2vdet_world_train_project/train_with_augment_template/weights/best.pt'
  ...
  wandb.watch(model)
  metrics = model.val(data="Object365.yaml",
                    batch=64,
                    workers=8,
                    save_json=True,
                    half=True,
