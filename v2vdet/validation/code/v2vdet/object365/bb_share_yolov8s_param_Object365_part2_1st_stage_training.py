...
def main():
  ...
  name = "bb_share_yolov8s_param_Object365_part2_1st_stage_training"
  
  ckpt_name = 'training_result/v2vdet/bb_share_yolov8s_param_Object365_part2_1st_stage_training/weights/best.pt'
